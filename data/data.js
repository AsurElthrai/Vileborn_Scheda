...
const RETAGGI = {
  ...
  Camminaspiriti: {
    ...
    doni: [
      { n: 1, nome: 'Pallidi Sussurri',   effetto: 'Entri in contatto con uno spirito e gli puoi porre una domanda a cui dovrà rispondere sinceramente.',                                           tuttavia: 'Il tuo aspetto si fa pallido e inquietante. Hai -1 nelle prove di ascendente finché questo dono rimane segnato.' },
      ...
      { n: 8, nome: 'Cuore Fermo',        effetto: 'Finché segnato non hai bisogno di bere, mangiare o dormire. Inoltre ignori gli effetti dell\'esaurimento, ma marchi comunque la casella.',     tuttavia: 'Senti un forte distacco dalla vita. Finché segnato non puoi mettere in gioco i tuoi moventi.' },
  ...
  Cantasangue: {
    ...
    doni: [
      ...
      { n: 4, nome: 'Traccia Cremisi',         effetto: 'Ti concentri sull\'odore del sangue di un soggetto: finché segnato puoi seguirne le tracce e conoscerne la direzione senza prove.',              tuttavia: 'Seguire la traccia ti ossessiona. Hai -1 alle prove di ragione finché questo dono rimane segnato.' },
      ...
      { n: 6, nome: 'Seduzione Oscura',        effetto: 'Risvegli emozioni viscerali in un soggetto. Hai +1 alle prove di ascendente contro di lui per questa scena.',                                    tuttavia: 'Il soggetto ti distrae. Hai svantaggio alle prove di precisione finché segnato, quando il soggetto è presente.' },
      ...
      { n: 8, nome: 'Precognizione del Sangue',effetto: 'Senti il fluire del sangue di un soggetto e ne prevedi i movimenti: hai +1 in tutte le prove fisiche contro di lui per la scena.',               tuttavia: 'Sei tentato dal suo sangue. Hai svantaggio alle prove di volontà contro il soggetto fino a fine scena.' },
  ...
  Celartigli: {
    ...
    doni: [
      ...
      { n: 3, nome: 'Vista da Predatore',     effetto: 'Puoi vedere dettagli minuscoli anche nel buio, hai +1 alle prove di precisione per questa scena.',                                                  tuttavia: 'L\'eccesso di stimoli visivi ti confonde. Hai -1 alle prove di ragione finché questo dono rimane segnato.' },
      ...
      { n: 7, nome: 'Movimenti Eccezionali',  effetto: 'Finché segnato puoi raggiungere luoghi inaccessibili, spiccando balzi, planando, strisciando ed emulando altri movimenti tipici dei predatori.',   tuttavia: 'Assumi un aspetto più animalesco che umano. Hai svantaggio alle prove di ascendente finché segnato.' },
      { n: 8, nome: 'Istinto Animale',        effetto: 'Superi istantaneamente una reazione di impeto, volontà o precisione senza bisogno di tirare.',                                                      tuttavia: 'Hai la forte tentazione di contrattaccare. Hai svantaggio alle prove di ragione finché segnato.' },
  ...
  Cercaselva: {
    ...
    doni: [
      { n: 1, nome: 'Radici Profonde',     effetto: 'Ti colleghi con la natura che ti circonda. Hai vantaggio alle prove di volontà e sei immune agli effetti dell\'ansia per il resto della scena.',      tuttavia: 'Sei rallentato dalla tua connessione con la terra. Hai -1 alle prove di impeto fino alla fine della scena.' },
      ...
      { n: 3, nome: 'Pelle di Corteccia',  effetto: 'Ignori le prossime 2 ferite che subiresti.',                                                                                                           tuttavia: 'Il tuo aspetto diventa inquietante. Hai svantaggio alle prove di ascendente finché segnato.' },
      ...
      { n: 6, nome: 'Andatura Esperta',    effetto: 'Finché segnato, ti muovi senza difficoltà in terreni naturali, anche difficoltosi o impervi.',                                                         tuttavia: 'Ti isoli nell\'abbraccio della natura e rifuggi i contatti umani. Finché segnato non puoi usare i tuoi legami.' },
  ...
  Crearovina: {
    ...
    doni: [
      ...
      { n: 5, nome: 'Eco della Rovina',       effetto: 'Attiri la malasorte su un soggetto, a cui accadono piccoli eventi sfortunati per questa scena. Hai vantaggio alle prove di sotterfugio contro di lui.',tuttavia: 'Il fatalismo si impossessa di te, hai -1 alle prove di volontà finché segnato.' },
  ...
  Danzaombre: {
    ...
    doni: [
      ...
      { n: 4, nome: 'Passeggero Oscuro',     effetto: 'Un passeggero riposa nella tua ombra: è completamente fatto di tenebre. Segna questo dono per farti aiutare in un\'azione, o per chiedere un piccolo semplice favore.', tuttavia: 'Finché segnato non puoi usare i tuoi legami.' },
      { n: 5, nome: 'Reazione d\'Ombra',     effetto: 'La tua ombra reagisce per te. Superi istantaneamente una reazione di volontà, ragione o precisione senza bisogno di tirare.',                          tuttavia: 'Finché segnato, la tua ombra si muoverà di sua volontà, rendendo evidente la tua natura e dandoti -1 alle prove di ascendente.' },
  ...
  Tessisorte: {
    ...
    doni: [
      ...
      { n: 6, nome: 'Dissolutezza Stregata', effetto: 'Hai vantaggio alle prove di sotterfugio e sei immune agli effetti della vergogna per questa scena.',                                                    tuttavia: 'La tua tempra morale ne risente. Hai -1 alle prove di volontà finché questo dono è segnato.' },
      { n: 7, nome: 'Specchio Arcano',       effetto: 'Assumi l\'aspetto di un soggetto che hai visto almeno una volta. L\'effetto rimane attivo per l\'intera durata della scena in corso.',                  tuttavia: 'La tua personalità potrebbe perdersi nella sua. Tira 1d6: se 1, non puoi usare i tuoi moventi finché segnato.' },
