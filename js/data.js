...
const RETAGGI = {
  ...
  Camminaspiriti: {
    ...
    doni: [
      ...
      { n: 2, nome: 'Presenza Eterea',    effetto: 'Materializzi uno spirito che ostacola un soggetto o agita piccoli oggetti in un\'area a tua scelta, fino alla fine del tuo prossimo turno.',   tuttavia: 'Ti esponi al tormento dello spirito evocato. Tira 1d6: se 1, subisci paura.', popup: { tipo: 'dado1', effetto: 'paura' } },
      ...
      { n: 4, nome: 'Ultima Scintilla',   effetto: 'Rivivi con tutti e cinque i sensi gli ultimi momenti di vita di un soggetto, dal suo punto di vista.',                                         tuttavia: 'Rischi di rivivere il trauma della sua morte. Tira 1d6: se 1, subisci una ferita.', popup: { tipo: 'dado1', effetto: 'ferita' } },
      { n: 5, nome: 'Possessione',        effetto: 'Richiami uno spirito e lo ospiti nel tuo corpo mortale. Aumenta di una taglia un approccio (massimo d10) per questa scena.',                  tuttavia: 'Lo spirito si nutre della tua energia. Tira 1d6: se 1, subisci esaurimento.', popup: { tipo: 'dado1', effetto: 'esau' } },
      ...
      { n: 7, nome: 'Visione di Morte',   effetto: 'Infliggi istantaneamente una ferita a un soggetto che puoi vedere, facendogli vivere per un attimo i tormenti dell\'aldilà.',                  tuttavia: 'Rischi di cedere alla brama di vendetta degli spiriti. Tira 1d6: se 1, subisci rabbia.', popup: { tipo: 'dado1', effetto: 'rabbia' } },
      ...
      { n: 9, nome: 'Martirio',           effetto: 'Cura istantaneamente una ferita di un tuo alleato. Se è fuori gioco, elimini la sua ultima ferita e lo fai tornare in gioco.',                 tuttavia: 'Sacrifichi la tua energia vitale. Subisci istantaneamente una ferita.', popup: { tipo: 'automatico', effetto: 'ferita' } },
    ]
  },
  ...
  Cantasangue: {
    ...
    doni: [
      { n: 1, nome: 'Battito Rivelatore',      effetto: 'Ti concentri sul battito cardiaco di un soggetto. Se ne ha uno, per questa scena sai se sta dicendo la verità.',                                tuttavia: 'Il battito che senti rischia di agitarti. Tira 1d6: se 1, subisci ansia.', popup: { tipo: 'dado1', effetto: 'ansia' } },
      { n: 2, nome: 'Potenza del Sangue',      effetto: 'Diventi incredibilmente forte per un istante. Usa il tuo turno per ottenere immediatamente un successo di impeto.',                              tuttavia: 'Metti il tuo cuore e il tuo fisico sotto sforzo. Tira 1d6: se 1, subisci una ferita.', popup: { tipo: 'dado1', effetto: 'ferita' } },
      ...
      { n: 5, nome: 'Nebbia Rossa',            effetto: 'Ti trasformi in nebbia per un momento. Puoi passare tra sbarre o grate, o reagire a un singolo attacco fisico senza bisogno di tirare.',        tuttavia: 'Cambiare forma è molto stancante. Tira 1d6: se 1, subisci esaurimento.', popup: { tipo: 'dado1', effetto: 'esau' } },
      ...
      { n: 7, nome: 'Scultore del Sangue',     effetto: 'Versi il tuo sangue e lo scolpisci in un\'arma della foggia che preferisci. Hai vantaggio a tutte le prove in cui la usi per questa scena.',    tuttavia: 'Ti infliggi una ferita a causa della copiosa perdita di sangue.', popup: { tipo: 'automatico', effetto: 'ferita' } },
      ...
      { n: 9, nome: 'Aritmia',                 effetto: 'Fai perdere un battito di cuore a un soggetto: la prossima volta che dovrà agire, non accadrà nulla. Se non ha battito, il dono non funziona.',  tuttavia: 'Devi concentrarti moltissimo per generare questo effetto. Subisci immediatamente esaurimento.', popup: { tipo: 'automatico', effetto: 'esau' } },
    ]
  },
  ...
  Celartigli: {
    ...
    doni: [
      { n: 1, nome: 'Forma Ferina',           effetto: 'Sviluppi tratti animali. Hai +1 alle prove di impeto e sei immune agli effetti dell\'esaurimento per questa scena.',                                tuttavia: 'Rischi di farti sopraffare dal tuo istinto di caccia. Tira 1d6: se 1, subisci rabbia.', popup: { tipo: 'dado1', effetto: 'rabbia' } },
      { n: 2, nome: 'Senso del Pericolo',     effetto: 'Il tuo istinto ti dice se ci sono minacce nei paraggi: l\'Oscurità ti rivela un indizio sulla loro natura, e sai con sicurezza se sono Oscuri.',   tuttavia: 'Il pericolo che percepisci rischia di metterti eccessivamente all\'erta. Tira 1d6: se 1, subisci ansia.', popup: { tipo: 'dado1', effetto: 'ansia' } },
      ...
      { n: 6, nome: 'Guarigione Accelerata',  effetto: 'Guarisci istantaneamente una ferita sfruttando il tuo metabolismo eccezionale.',                                                                    tuttavia: 'Rischi di affamarti per la velocità del tuo metabolismo. Tira 1d6: se 1, subisci esaurimento.', popup: { tipo: 'dado1', effetto: 'esau' } },
  ...
  Cercaselva: {
    ...
    doni: [
      ...
      { n: 2, nome: 'Vento Ristoratore',   effetto: 'Purifichi un\'area circoscritta, come una radura o un breve corso d\'acqua, da tossine, effetti venefici e sostanze pericolose.',                     tuttavia: 'Il tuo corpo rischia di assorbire parte della contaminazione. Tira 1d6: se 1, subisci una ferita.', popup: { tipo: 'dado1', effetto: 'ferita' } },
      ...
      { n: 7, nome: 'Rancore della Terra', effetto: 'Usa il tuo turno per scatenare un attacco che sfrutta gli elementi naturali. Ottieni immediatamente un successo di impeto.',                           tuttavia: 'Il caos della natura rischia di inebriarti e farti perdere il controllo. Tira 1d6: se 1, subisci rabbia.', popup: { tipo: 'dado1', effetto: 'rabbia' } },
      { n: 8, nome: 'Forza delle Montagne',effetto: 'La tua forza si moltiplica, hai +1 alle prove di impeto e ignori gli effetti dell\'esaurimento per il resto della scena.',                             tuttavia: 'Rischi di farti spaventare dalla tua forza. Tira 1d6: se 1, subisci paura.', popup: { tipo: 'dado1', effetto: 'paura' } },
  ...
  Crearovina: {
    ...
    doni: [
      { n: 1, nome: 'Oscuro Presagio',        effetto: 'Chiedi all\'Oscurità di rivelarti qual è il pericolo più imminente per un soggetto, te lo rivelerà attraverso una breve visione.',                   tuttavia: 'La visione rischia di spaventarti. Tira 1d6: se 1, subisci paura.', popup: { tipo: 'dado1', effetto: 'paura' } },
      { n: 2, nome: 'Destino Deviato',        effetto: 'Ti immedesimi per breve tempo in una versione di te che ha vissuto un destino migliore. Per una scena, aumenti un approccio a tua scelta di una taglia (massimo d10).', tuttavia: 'Rischi di rimpiangere la fortuna che non hai avuto. Tira 1d6: se 1, subisci rabbia.', popup: { tipo: 'dado1', effetto: 'rabbia' } },
      ...
      { n: 9, nome: 'Sogno Premonitore',      effetto: 'Prima di dormire, chiedi all\'Oscurità di raccontarti un presagio su un argomento a tua scelta. Ti racconterà qualcosa di significativo nella forma di una visione onirica.', tuttavia: 'Il sogno turba il tuo sonno. Subisci esaurimento.', popup: { tipo: 'automatico', effetto: 'esau' } },
    ]
  },
  ...
  Danzaombre: {
    ...
    doni: [
      { n: 1, nome: 'Fame delle Ombre',      effetto: 'La tua ombra divora le emozioni negative. Rimuovi una condizione, tua o di un alleato, e ottieni +1 alle prove di ragione fino alla fine della scena.', tuttavia: 'Le Ombre rischiano di colmare e dilaniare il tuo corpo. Tira 1d6: se 1, piangi lacrime nere come la pece e subisci una ferita.', popup: { tipo: 'dado1', effetto: 'ferita' } },
      { n: 2, nome: 'Freddo, Troppo Freddo', effetto: 'Sottrai il calore da una piccola area o raffreddi un oggetto. Se questo è a contatto con la pelle di un soggetto, dovrà lasciarlo cadere o subire una ferita.', tuttavia: 'Rischi di perdere tu stesso calore corporeo. Tira 1d6: se 1, subisci esaurimento.', popup: { tipo: 'dado1', effetto: 'esau' } },
      { n: 3, nome: 'Oscuri Segreti',        effetto: 'Ti metti in contatto con le Ombre, che ti sussurreranno quali sono le emozioni che permeano il luogo in cui ti trovi.',                                tuttavia: 'Queste emozioni ti rimangono attaccate addosso. Tira 1d6: se 1, subisci ansia.', popup: { tipo: 'dado1', effetto: 'ansia' } },
      ...
      { n: 8, nome: 'Terrori Notturni',      effetto: 'Materializzi le paure di un soggetto nella sua mente, distraendolo, spaventandolo o peggio, a scelta dell\'Oscurità.',                                  tuttavia: 'Potresti materializzare le tue stesse paure. Tira 1d6: se 1, subisci paura.', popup: { tipo: 'dado1', effetto: 'paura' } },
  ...
  Tessisorte: {
    ...
    doni: [
      ...
      { n: 2, nome: 'Paradosso Fatato',      effetto: 'Sovverti leggermente la fisica per un attimo. Cadi più lentamente di quanto dovresti, passi in uno spazio troppo stretto per te, sposti un oggetto troppo pesante per te.', tuttavia: 'La tua mente si ribella all\'illogicità di ciò che accade. Tira 1d6: se 1, subisci confusione.', popup: { tipo: 'dado1', effetto: 'conf' } },
      ...
      { n: 7, nome: 'Specchio Arcano',       effetto: 'Assumi l\'aspetto di un soggetto che hai visto almeno una volta. L\'effetto rimane attivo per l\'intera durata della scena in corso.',                  tuttavia: 'La tua personalità potrebbe perdersi nella sua. Tira 1d6: se 1, non puoi usare i tuoi moventi finché segnato.', popup: { tipo: 'dado1', effetto: 'blocca:moventi' } },
